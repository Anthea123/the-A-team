...
void interface(SDL_Surface *ecran){
  SDL_Surface *blue=NULL,*green=NULL,*red=NULL,*yellow=NULL,*purple=NULL,*grey=NULL,*hint=NULL,*reset=NULL,*back=NULL;
  ...
  drawTexture(ecran,0,760,0.3,hint);
  drawTexture(ecran,300,0,0.5,reset);
  drawTexture(ecran,500,10,0.3,back);
  SDL_Flip(ecran);
